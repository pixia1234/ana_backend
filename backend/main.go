...
var clientConf = goauth.Config{
	ClientID:     "my-client",
	ClientSecret: "foobar",
	RedirectURL:  "http://52.77.249.124:3846/callback",
	Scopes:       []string{"photos", "openid", "offline"},
	Endpoint: goauth.Endpoint{
		TokenURL: "http://52.77.249.124:3846/oauth2/token",
		AuthURL:  "http://52.77.249.124:3846/oauth2/auth",
	},
}
...
func main() {
	...
	fmt.Println("Please open your webbrowser at http://52.77.249.124:" + port)
	_ = exec.Command("open", "http://52.77.249.124:"+port).Run()
